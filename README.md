...
- Система контроля версий - GitHub/Gittab/BitBucket;
...
Лишний вес не сбрасывается только упражнениями, основная задача - кушать ровно столько калорий сколько тратишь. В этом помогут кухонные весы и [MyFitnessPal](http://thespanishsite.com/public_html/org/ergo/rsi.html) или [Fat Secret](https://www.fatsecret.com/).
